...
float lectura_sensor_izq = 0; // variable to save the left sensor readings.
float lectura_sensor_der = 0; // variable to save the right sensor readings.
...
void loop() {
  ...
  lectura_sensor_der = prueba_de_sonico.read(1, 30); // The sensor on the left is read.
  delay(20);
  String tmp = "";
